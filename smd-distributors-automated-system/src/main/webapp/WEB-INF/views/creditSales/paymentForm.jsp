	...
	<form action="../../pay" method="Post">
		...
		<div class="mb-3">
			<label for="formGroupExampleInput" class="form-label">Customer
				ID :</label><br> <input type="text" class="form-control" id="CID" name="CID"
				Required>
		</div>
		<div class="mb-3">
			<label for="formGroupExampleInput" class="form-label">Invoice
				ID :</label> <input type="text" class="form-control" id="OID" name="OID" Required>
		</div>

		<div class="mb-3">
			<label for="formGroupExampleInput" class="form-label">Amount
				:</label> <input type="text" class="form-control" id="PidAmount" name="PaidAmount" Required>
		</div>
