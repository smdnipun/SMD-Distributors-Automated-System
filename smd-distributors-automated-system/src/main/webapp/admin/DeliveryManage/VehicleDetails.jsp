		...
		<div class="col-10">
			...
			<table class="table table-hover">
				...
				<tbody>
					<c:forEach var="veh" items="${vehicleDetails}">
						...
						<form action=<%=request.getContextPath() + "/vdeleted"%>
							method="post">
							<tr>
								<td />
								<td />
								...
								<td />
								<td />
								<td><input type="hidden" value="${veh.getVehicleNum()}"
									name="vnum" class="form-control" id="formGroupExampleInput"
									readonly /></td>
			...
			<div class="col-4">
				...
				<form autocomplete="off"
					action="<%=request.getContextPath() + "/addveh"%>" method="post">
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Vehicle
							Number</label> <input type="text" name="vnum" aria-describedby=""
							class="form-control" id="formGroupExampleInput">
					</div>
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Insurence
							EXP Date</label> <input type="date" name="idate" aria-describedby=""
							class="form-control" id="formGroupExampleInput">
					</div>
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Licence
							EXP Date</label> <input type="date" name="ldate" aria-describedby=""
							class="form-control" id="formGroupExampleInput">
					</div>
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Vehicle
							Type</label> <select class="dropdown-header" name="type"
					...
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Supported
							Weight(Ton)</label> <input type="number" name="weight"
							aria-describedby="" class="form-control"
							id="formGroupExampleInput" min="1" max="10">
					</div>
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Status</label>
						<select class="dropdown-header" name="status"
							id="formGroupExampleInput">
					...
					<button type="submit" name="submit" class="btn btn-primary"
						style="background-color: #fbda57; color: #000000">Add</button>
				</form>
