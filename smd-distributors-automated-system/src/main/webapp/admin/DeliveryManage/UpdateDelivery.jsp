...
<div class="mb-3">
  ...
  <select class="dropdown-header" name="upStatus" id="formGroupExampleInput">
...
<input type="submit" name="uodate" value="Update" class="btn btn-primary"style="background-color:#fbda57; color:#000000"> 
